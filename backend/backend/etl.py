...
class WeatherForecastDataETLHelper:
    ...
    def extract_from_tbofs_api(self, date: datetime.datetime):
        ...
        # <base_url>/<year>/<month>/<day>/<base_filename>.<year><month><day>.t<cycle>z.nc
        #
        # This dataset includes forecasts for Tampa Bay area.
        #
        # The forecast is performed every 6 hours each day, each
        # being 2-days long. Cycles are labeled as 0, 6, 12, or 18. It
        # is assumed that each is at the start of a 6-hour interval.
        #
